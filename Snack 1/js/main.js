/*
 ...
 genero un numero compreso tra il valore minimo
 ed il valore massimo forniti dall'utente
*/

// RICHIESTA PER L'UTENTE DEI NUMERI MAX e MIN
let numMin = parseInt(prompt("inserisci un numero minimo"));
let numMax = parseInt(prompt("inserisci un numero massimo"));
